...
class MyHomePage extends StatelessWidget {
  const MyHomePage({Key? key}) : super(key: key); // Marqué comme const
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const AddMedicinePage(), // Remarque l'utilisation de const ici
    );
  }
}

class AddMedicinePage extends StatefulWidget {
  const AddMedicinePage({Key? key}) : super(key: key); // Ajout du const ici
